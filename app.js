let currentLang = 'ar';
        ...
        const translations = {
            ar: {
                ...
                "blog-hero-kicker": "MOVEXA TV",
                "blog-hero-title": "مكتبة محتوى ضخمة",
                ...
                "games-kicker": "ألعاب بلا حدود",
                "games-title": "عالم الألعاب عليك",
                "games-subtitle": "استمتع بأشهر ألعاب الفيديو العالمية والعربية بدقة عالية وأداء سلس دون تقطيع، مع مكتبة ضخمة تتجدد بمحتوى جديد وحصري يوميًا على جميع أجهزتك.",
            ...
            en: {
                ...
                "blog-hero-kicker": "MOVEXA TV",
                "blog-hero-title": "A Massive Content Library",
                "games-kicker": "Game World",
                "games-title": "The Latest Games for You",
                "games-subtitle": "Enjoy popular world and Arabic video games with high quality and smooth performance on all your devices, with a huge library constantly updated with new exclusive content.",
